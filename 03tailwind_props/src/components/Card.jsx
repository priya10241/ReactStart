...
function Card({heading,animalName="Name"}){
    return (
        ...
        Quis necessitatibus culpa non vero libero deserunt debitis nostrum magnam aliquam cupiditate aperiam impedit quidem pariatur, quos quae? Sunt nemo aut molestias, iste reiciendis iure culpa magni soluta vitae animi.</p>
        </div>
        </div>
        </>
    ) 
